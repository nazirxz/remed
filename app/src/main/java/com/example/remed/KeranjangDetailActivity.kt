...
import com.example.remed.databinding.KeranjangDetailActivityBinding
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.FirebaseDatabase
import com.google.firebase.database.ValueEventListener

class KeranjangDetailActivity:AppCompatActivity() {
    private lateinit var binding: KeranjangDetailActivityBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= KeranjangDetailActivityBinding.inflate(layoutInflater)
